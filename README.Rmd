...
This will give you the following structure, where each row represents an individual variables and columns are the different plots you would like to inspect:
...
Then creating a standardised EDA file is just as easy as: doing something like this:

### `r credit_data_nested$variable[[1]]` {.tabset .tabset-fade .tabset-pills}
...
### `r credit_data_nested$variable[[2]]` {.tabset .tabset-fade .tabset-pills}
