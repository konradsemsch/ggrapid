...
This will give you the following structure, where each row represents an individual variable and columns are the different plots you would like to inspect:
